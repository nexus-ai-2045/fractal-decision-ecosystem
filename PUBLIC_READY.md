...
This package is prepared as a standalone public candidate for Fractal Decision
Ecosystem（FDE）. The source workspace, draft work folders, machine-local paths,
and private operational state are outside the public boundary.
