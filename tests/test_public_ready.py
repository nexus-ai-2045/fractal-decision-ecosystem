...
def test_operational_guarantee_records_post_merge_receipts_without_public_approval() -> None:
    ...
    for term in (
        ...
        "未実装ロードマップ",
        "future scope",
        "Current public GitHub PR receipts",
        "#1",
        "81804ccf7e493f64d9d383012604db0c115fbe00",
        "#6",
        "e75a9398583d381db3dc990eaa81d0333ddc9bb0",
        "historical (#7)",
        "94affdd3a02a38053d67a3f469a9244d401fa448",
        "historical (#8)",
        "151d88cff34e2703d220aabb9d489ef0e04fa7a6",
        "現行 GitHub の同番号 PR とは別物",
