---
title: Fractal Decision Ecosystem 索引
type: index
status: active
created: 2026-05-13
owner: codex
...
- 人間が読む本文、見出し、説明文は日本語で書く。
- code identifier、schema field、file name、GitHub Actions keyword、frontmatter key は英語のまま維持する。
- 英語の専門語を残す場合は、必要に応じて日本語説明を添える。
