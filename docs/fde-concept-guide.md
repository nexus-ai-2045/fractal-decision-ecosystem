---
title: FDE concept guide
type: reference
status: active
created: 2026-05-13
owner: codex
scope: fde
tags: [fde, concept, guide]
---

# FDE 概念ガイド

入口の要約は [README.md](../README.md) を見てください。この文書は判断ループ、発火条件、主要 file、配置ルールなどの詳細です。
...
実装保証runtimeからFDEへ学びを戻す時は、[`fde.feedback.v1`](feedback-loop-packet.md)を使います。FDEはroutingとhuman gate、実装保証runtimeはPlan / Do / Check / Actの証拠を担当し、会話全文ではなく次Planに必要な最小packetだけを受け渡します。
